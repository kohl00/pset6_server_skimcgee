...
int main(int argc, char* argv[])
{
    ...
    while (true)
    {
        ...
        if (connected())
        {
            ...
            //strchnul is like strchr except returns pointer to null byte aka null terminator instead of NULL
...
const char* lookup(const char* extension)
{
    ...
    if(extension != NULL)
    {
     if(strcasecmp("css",strlwr(extension)) == 0){
       return "text/css";
     }
     if(strcasecmp("html",strlwr(extension)) == 0){
       return "text/html";
     }
     if(strcasecmp("gif",strlwr(extension)) == 0){
       return "image/gif";
     }
     if(strcasecmp("ico",strlwr(extension)) == 0){
       return "image/x-icon";
     }
     ...
     if(strcasecmp("png",strlwr(extension)) == 0){
       return "text/png";
     }
    }
    return NULL;
